...
We'll make 3 interesting tibbles:
...
1. `eset_tib_genes`: preprocessed expression data for the samples we're analyzing. Each row is a gene.
...
Blah blah blah how microarrays work. Probably reference opening of RMA paper.
