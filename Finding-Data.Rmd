...
I've combined data for T cells across tables S1, S4, and S5 in [my curated version](https://docs.google.com/spreadsheets/d/1AI00Q3MK53dZ3K1YqrncKoQm0Kxj1CFOQgfrl3lp7fM/edit). They've catalogued data for 1,776 samples from 65 GEO series for 22 different T cell phenotypes across 4 (?) different array platforms. We should explore this data!

```{r mcp-counter-data}
mcp_datasets <- c("Chtanova", "GSE10586", "GSE11057", "GSE11188", "GSE11292", 
