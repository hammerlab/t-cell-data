...
getData(gh)@parameters@data %>% select(name, desc)
```
...
print(list(cell_types=cell_types, cell_states=cell_states))
```
...
```{r flow-plot-terminal-gates, fig.width=8, fig.height=8}
