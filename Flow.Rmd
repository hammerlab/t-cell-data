...
```{r OMIP-021-figure, fig.align='center', fig.cap='Gating strategy illustrated with annotated figures from OMIP-021', echo=FALSE}
knitr::include_graphics('images/OMIP021.png')
```
